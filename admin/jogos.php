...
$stmt = $pdo->prepare("SELECT COUNT(*) as total FROM jogo j WHERE $where_sql");
$stmt->execute($params);
        ...
        <div class="admin-content">
            ...
            <div class="data-table-wrapper">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo SITE_URL; ?>jogo-detalhes.php?id=<?php echo $jogo['id']; ?>" 
                ...
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="?page=<?php echo $page - 1; ?><?php echo http_build_query($query_params) ? '&' . http_build_query($query_params) : ''; ?>">
                            <i class="fas fa-chevron-left"></i>
                        </a>
                    <?php endif; ?>
                    
                    <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                        <a href="?page=<?php echo $i; ?><?php echo http_build_query($query_params) ? '&' . http_build_query($query_params) : ''; ?>" 
