...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        if ($action == 'update_info') {
            ...
            if (!in_array($ext, $allowed_ext)) throw new Exception("Formato não permitido. Use JPG, PNG ou WebP.");
            ...
            if (!in_array($mime, $allowed_types)) throw new Exception("Tipo de arquivo inválido.");
            ...
            // Comprimir imagem para 100px de largura
            if (compressImage($file['tmp_name'], $filepath, 100, COMPRESSION_QUALITY)) {
