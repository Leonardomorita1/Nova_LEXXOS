...
$stmt = $pdo->prepare("
    SELECT j.*, c.id as carrinho_id, c.adicionado_em,
...
if (isset($_SESSION['cupom_aplicado'])) {
    ...
    $desconto_cupom = $cupom['desconto_calculado'] ?? 0;
}
    ...
    <div class="container">
        <div class="cart-header">
            ...
            <div class="cart-header-actions">
                <button type="button" class="btn btn-ghost btn-sm" data-action="clear-cart">
            ...
            <div class="cart-items">
                ...
                <article class="cart-item" data-cart-item data-jogo-id="<?= $item['id'] ?>">
                    ...
                    <button type="button" 
                            ...
                            onclick="Cart.removeItem(<?= $item['id'] ?>, this)"
            ...
            <aside class="cart-summary">
                ...
                <div class="cart-summary-rows">
                    ...
                    <div class="cart-summary-row cart-summary-coupon">
                        <span>
                            ...
                            <button type="button" onclick="Coupon.remove()" class="coupon-remove-btn">
                                <i class="fas fa-times"></i>
                            </button>
                        </span>
                ...
                <div class="cart-coupon-form">
                    ...
                    <button type="button" 
                            ...
                            onclick="Coupon.apply(document.getElementById('coupon-input').value)">
                        Aplicar
                    </button>
                </div>
                <?php endif; ?>
