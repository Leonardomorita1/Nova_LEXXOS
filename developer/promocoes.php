...
<style>
    ...
    .tab:hover {
        color: var(--text-primary);
        background: rgba(var(--accent-rgb, 76, 139, 245), 0.05);
    }
    ...
    .promo-card:hover {
        box-shadow: var(--shadow-md);
        border-color: rgba(var(--accent-rgb, 76, 139, 245), 0.3);
    }
    ...
    .btn-primary:hover {
        background: var(--accent-hover, #5a8de8);
    }
    ...
    .game-checkbox:has(input:checked) {
        border-color: var(--accent);
        background: rgba(var(--accent-rgb, 76, 139, 245), 0.1);
    }
            ...
            <div class="dev-promo-container">
                ...
                <div id="tab-monitor" class="tab-content active">
                    ...
                    <?php if (empty($jogos)): ?>
                        <div class="empty-state"><i class="fas fa-gamepad"></i>
                            <p>Você ainda não tem jogos publicados</p>
                        </div>
                    <?php else: ?>
                ...
                <div id="tab-promocoes" class="tab-content">
                    <?php if (empty($promocoes)): ?>
                        <div class="empty-state"><i class="fas fa-tags"></i>
        ...
        <div class="form-content">
            ...
            <form method="POST">
                ...
                <div class="form-body">
                    ...
                    <div class="form-grid-2">
                        <div class="form-group"><label class="form-label">Tipo *</label><select name="tipo_desconto" class="form-control">
                    ...
                    <div class="form-group"><label class="form-label">Aplicar a:</label>
                        <select name="jogo_id" class="form-control">
                            <option value="">Todos os jogos</option><?php foreach ($jogos as $j): ?><option value="<?= $j['id'] ?>"><?= htmlspecialchars($j['titulo']) ?></option><?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-grid-2">
        ...
        <div class="form-content">
            ...
            <form method="POST">
                ...
                <div class="form-body">
                    ...
                    <div class="form-grid-2">
                        <div class="form-group"><label class="form-label">Tipo *</label><select name="tipo_desconto" id="edit_cupom_tipo" class="form-control">
                                <option value="percentual">Percentual (%)</option>
                                <option value="fixo">Valor Fixo (R$)</option>
                            </select></div>
                    ...
                    <div class="form-group"><label class="form-label">Status *</label><select name="ativo" id="edit_cupom_ativo" class="form-control">
...
<script>
    ...
    document.querySelectorAll('.form-modal').forEach(m => m.addEventListener('click', e => {
        if (e.target === m) closeModal(m.id);
    }));
    document.addEventListener('keydown', e => {
        if (e.key === 'Escape') {
            const m = document.querySelector('.form-modal.active');
    ...
    if (codigoInput) codigoInput.addEventListener('input', function() {
